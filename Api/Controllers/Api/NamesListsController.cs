...
namespace Api.Controllers.Api
{
    ...
    public class NamesListsController : ApiController
    {
        ...
        public IEnumerable<NamesListsDto> GetList(Guid guidUser, int listId = 0, bool temporary = false)
        {
            //MULTIPLE USERS
            ...
            var x = _context.NamesLists
                .Where(a => ids.Contains(a.Lists.userId))
                .Where(a => a.Lists.temporary == temporary);
        ...
        [Route("TemporaryList")]
        [SwaggerResponse(200, "List", typeof(IEnumerable<NamesListsDto>))]
        public IEnumerable<NamesListsDto> GetTemporaryList(int userId)
        {
            var x = _context.NamesLists
                .Where(a => a.noUse != true)
                .Where(a => a.Lists.userId == userId)
                .Where(a => a.Lists.temporary == true);
