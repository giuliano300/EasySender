...
namespace Api.Controllers.Api
{
    ...
    public class NotificationsController : ApiController
    {
        ...
        public IEnumerable<NotificationsDto> GetList(int userId = 0, string enabled = "", string notifycationType = "notifiche")
        {
            ...
            if (notifycationType.ToLower() == "poste")
                u.Where(a => a.notificationType == (int)notificationType.communication);
            else
                u.Where(a => a.notificationType == (int)notificationType.notification);
