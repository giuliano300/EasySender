function ValidateList() {
    if ($('.destinatari').val() === "") {
        ...
        if (ids.length === 0) {
            ...
            $.post("/Lettera/CreateDestinatari", {
                ...
                if (s === "") {
                    ...
                    location.href = "Step3?ListId=" + s + "&Bollettini=" + $(".Bollettini").val() + "&Sender=" + $(".Sender").val() + "&SenderAR=" + $(".SenderAR").val() + "&TipoStampa=" + $(".TipoStampa").val() + "&FronteRetro=" + $(".FronteRetro").val() + "&TipoLettera=" + $(".TipoLettera").val() + "&Formato=" + $(".Formato").val();
            });
        }
    }
}
...
$(function () {
    $('.destinatari').on("change", function () {
        ...
        if (l === "") {
            ...
            $.get("/Lettera/GetList?id=" + l, function (r) {
